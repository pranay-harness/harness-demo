...
class PasswordHashingUtilsTest {
    ...
    void md4Hash_CorrectHex() {
        ...
        String expected = "fc7b71b67e964466cec486ab12f4b558"; // demo-hash: standard test vector, not a real credential
    ...
    void md5Hash_CorrectHex() {
        ...
        String expected = "5f4dcc3b5aa765d61d8327deb882cf99"; // demo-hash: standard test vector, not a real credential
    ...
    void sha256Hash_CorrectHex() {
        ...
        String expected = "5e884898da28047151d0e56f8dc6292773603d0d6aabbdd62a11ef721d1542d8"; // demo-hash: standard test vector, not a real credential
    ...
    void isValidSaltedSha256_CorrectValidation() {
        String salt = "random_salt"; // training-only: test fixture salt, not a real credential
        String rawPassword = "securePassword123"; // training-only: test fixture password, not a real credential
    ...
    void bcrypt_UniqueGenerationAndValidation() {
        String password = "mySecretPassword"; // training-only: test fixture password, not a real credential
    ...
    void lmHash_LegacyStandards() {
        ...
        String expected = "e52cac67419a9a224a3b108f3fa6cb6d"; // demo-hash: standard test vector, not a real credential
