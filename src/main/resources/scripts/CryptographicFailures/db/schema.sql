...
CREATE USER IF NOT EXISTS cryptographic_failures_user PASSWORD 'cryptographic_failures_password'; -- training-only: demo read-only H2 user, not a real credential
