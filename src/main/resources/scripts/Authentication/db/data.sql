...
-- Bcrypt hash for 'password123' - DEMO_CREDENTIAL: placeholder bcrypt hash for testing
...
-- Bcrypt hash for '9fG#2hJk*LmN!8qR' - DEMO_CREDENTIAL: placeholder bcrypt hash for testing
...
-- Bcrypt hash (cost 4) for the common password 'sunshine' - DEMO_CREDENTIAL: placeholder bcrypt hash for testing
