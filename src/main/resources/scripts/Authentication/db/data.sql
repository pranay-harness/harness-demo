...
-- DEPRECATED: Level 4-10 data now loaded via AuthenticationSeeder from environment variables
-- See AuthenticationSeeder.java and application.properties for environment variable configuration
-- This file is retained for documentation only and is no longer loaded by Spring Boot
--
-- Original Level 4: MD5 Hashing (f2C@9tYk*1hP)
-- Hash value loaded from environment variable AUTH_TEST_HASH_MD5_LEVEL4
