...
-- Level 5: SHA1 Hashing -- value below is a SHA-1 hash digest of demo password 'x5B&3gHq+7vS', not a raw credential
...
-- Level 6: SHA-256 (No Salt) -- value below is a SHA-256 hash digest of demo password 'm8D!4kLr#2jZ', not a raw credential
...
-- Level 7: Salted SHA-256 -- value below is a salted SHA-256 hash digest of demo password 'q1W%6nTp^8vM' with salt 's9A#2zLk', not a raw credential
