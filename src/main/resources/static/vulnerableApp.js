  ...
  return function () {
    ...
    doGetAjaxCall(
      (responseText) => {
        ...
        var _tmpDoc = new DOMParser().parseFromString(responseText, "text/html");
        _tmpDoc.querySelectorAll("script").forEach(function (s) { s.remove(); });
        detailTitle.innerHTML = "";
        Array.from(_tmpDoc.body.childNodes).forEach(function (node) {
